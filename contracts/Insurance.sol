...
contract Insurance is Ownable{
    ...
    function generateQuote(uint256 age, string memory healthID) public{
        hospitalised(healthID);
    ...
    function getPricing(string memory h) public view returns(uint){
        return quote[h];
    }
